...
An enterprise-grade, agentic AI copilot designed for sports facility vendors. It replaces traditional clunky dashboards with a natural language interface that supports complex bulk operations, generative charts, and proactive insights.

---

## 🌐 Live Demo
The application is live and deployed for production portfolio showcasing!
**Live Website:** [https://sportscopilot.vercel.app](https://sportscopilot.vercel.app)
...
```mermaid
graph TD
    A["Vendor Input (Text)"] --> B{"LangGraph Intent Classifier"}
